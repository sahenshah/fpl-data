...
// api/v1/players/[id]/history/past.ts
...
// api/v1/managers/[id]/snapshot.ts
...
var onRequestGet2 = /* @__PURE__ */ __name(async ({ env: env2, params, request }) => {
...
// api/v1/players/[id]/history.ts
var onRequestGet3 = /* @__PURE__ */ __name(async ({ env: env2, params }) => {
  const sql = getSql(env2);
...
// api/v1/dashboard.ts
var onRequestGet5 = /* @__PURE__ */ __name(async ({ env: env2, request }) => {
  const sql = getSql(env2);
...
// ../.wrangler/tmp/pages-1IvJ7d/functionsRoutes-0.28261742052233974.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-75sks6/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-75sks6/middleware-loader.entry.ts
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=functionsWorker-0.07522377901139743.mjs.map
